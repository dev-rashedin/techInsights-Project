      ...
      <div className='mt-4'>
        ...
        <div className='mb-12 p-4 grid gap-y-10 gap-x-6 xl:gap-x-12 md:grid-cols-2 xl:grid-cols-4 justify-items-center'>
          ...
          <div className='dashboardSmallCard'>
            ...
            <div className='p-4 text-right'>
              <p className='block antialiased font-sans text-lg font-semibold text-blue-gray-600 tracking-wider  leading-relaxed'>
                Total User
              </p>
          ...
          <div className='dashboardSmallCard'>
            ...
            <div className='p-4 text-right'>
              <p className='block antialiased font-sans text-lg font-semibold text-blue-gray-600  leading-relaxed'>
                Published Articles
              </p>
              <h4 className='block antialiased tracking-normal font-sans text-3xl font-bold leading-snug text-blue-gray-900'>
                {publishedArticle}
        ...
        <div className='my-8  gap-6 flex flex-col-reverse xl:flex-row'>
          ...
          <div className='bg-clip-border rounded-xl bg-slate-200 text-gray-700 shadow-md overflow-hidden w-full xl:w-1/3 h-[300px] xl:h-[420px] mx-auto pb-12 xl:pb-40'>
            <p className='font-semibold pt-8 text-center text-lg'>
              User Subscription
            </p>
